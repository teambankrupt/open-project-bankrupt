 ...
 * Purpose:  Provide 'fixed' header, footer.html and columns for a DataTable
 ...
 *    * bool:bottom - fix the footer.html (default false)
 *    * int:left -    fix the left column(s) (default 0)
 *    * int:right -   fix the right column(s) (default 0)
 *    * int:zTop -    fixed header zIndex
 *    * int:zBottom - fixed footer.html zIndex
...
FixedHeader.prototype = {
	...
	_fnCloneTfoot: function ( oCache )
	{
		...
		/* Clone the DataTables footer.html */

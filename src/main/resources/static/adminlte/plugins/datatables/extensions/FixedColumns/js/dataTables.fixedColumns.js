...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 * grouping wrapper element and then a head, body and footer.html wrapper. In each of these we then
	 * place the cloned header, body or footer.html tables. This effectively gives as 3x3 grid structure.
	 *  @returns {void}
	 *  @private
	 */
	...
	"_fnGridLayout": function ()
	{
		...
		if ( this.s.iLeftColumns > 0 )
		{
			...
			if ( oGrid.left.foot ) {
				oGrid.left.foot.style.top = (oOverflow.x ? oOverflow.bar : 0)+"px"; // shift footer.html for scrollbar
			}
	 ...
	 *  @returns {void}
	 *  @param   {Boolean} bAll Indicate if the header and footer.html should be updated as well (true)
	 *  @private
	 */
	...
	/**
	 * Make a copy of the layout object for a header or footer.html element from DataTables. Note that
	 ...
	 *  @returns {void}
	 *  @param   {Object} oClone Object containing the header, footer.html and body cloned DOM elements
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		if ( dt.nTFoot !== null )
		{
			if ( bAll )
			{
				...
				/* Copy the footer.html just like we do for the header */
		...
		/* Equalise the column widths between the header footer.html and body - body get's priority */

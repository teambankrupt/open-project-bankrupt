...
class AddressController @Autowired constructor(
    ...
    override fun create(@Valid @RequestBody dto: AddressDto): ResponseEntity<Any> {
    ...
    override fun update(@PathVariable id: Long, @Valid @RequestBody dto: AddressDto): ResponseEntity<Any> {
